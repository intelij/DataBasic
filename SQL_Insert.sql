...
INSERT INTO RideShare (destination, price, DID, address, postalCode, province, city, rdate, rtime, CDate, Ctime)
VALUES ('whistler', 10, 123, '523 Abbot Street', 'V7D4M0', 'BC', 'Vancouver', '2/15/2016', '10:00 AM', '2/13/2016', '5:43 PM'),
  ('big white', 5, 234, '324 Abbot Street', 'V7D4M0', 'BC', 'Richmond', '2/16/2016', '6:00 AM', '2/13/2016', '5:40 PM'),
  ('revelstoke', 15, 345, '109 Spruce Street', 'V7D4B1', 'BC', 'Vancouver', '2/17/2016', '9:00 AM', '2/14/2016', '1:20 AM'),
  ('whistler', 20, 456, '214 41st Ave', 'V7D4P4', 'BC', 'Surrey', '2/18/2016', '7:00 AM', '2/14/2016', '1:04 PM'),
  ('victoria', 10, 567, '1234 West Mall', 'V7D4S2', 'BC', 'Burnaby', '2/19/2016', '9:00 AM', '2/11/2016', '2:30 AM');

INSERT INTO Participates (PID,RID)
VALUES (567, 123),
(123, 123),
(345, 456),
(234, 456),
...
INSERT INTO Transaction (type, RID, PID)
VALUES ('Cash', 123, 567),
('Cash', 123, 123),
('Cash', 456, 345),
('PayPal', 456, 234),
